...
def synthesize(weather, events, reminders, discord_msgs, pending_qs, health_issues, wire=None) -> str:
    now = datetime.now()
    hour = now.hour
    if hour < 12:
...
def main():
    ...
    # Synthesize
    narrative = synthesize(weather, events, reminders, discord_msgs, pending_qs, health_issues, wire)
