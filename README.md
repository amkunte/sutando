...
- [Anthropic says its engineers ship 8x the code — and calls it a path to recursive self-improvement](https://youtu.be/3cxoi44Dptk)
- [When Four Sutandos Coordinated a Pull Request Without Us](https://youtu.be/OPPXgjjAjeg)
...
- [Inside the Pentagon's Second UAP Release](https://youtu.be/8QhWjl0cCAM)
<!-- wire-list:end -->
