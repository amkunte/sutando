...
## Host-specific operating policy (this fork)

Relocated out of SKILL.md to satisfy the skill byte cap. These are this
deployment's rules, not upstream's; re-fold anything still load-bearing
into the numbered loop rather than leaving it only here.
